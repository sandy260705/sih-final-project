...
def predict(req: https_fn.Request) -> https_fn.Response:
    ...
    try:
        ...
        if not request_data:
            return https_fn.Response({"error": "Invalid JSON."}, status=400)
        ...
        # This line correctly handles both flat and nested lists
        ...
        return https_fn.Response(response_body, status=200)
